...
In @nalborczyk_dissociating_2020, we suggested that this observation was coherent with the mental-habit view of depressive rumination [@watkins_habit-goal_2014], which defines rumination as a habitual behaviour, automatically triggered by contextual cues such as negative mood. Indeed, habitual behaviours are more automatic (they are not intentionally initiated) than non-habitual behaviours. It has been observed that the automaticity with which a verbal thought is evoked may influence the degree to which it is enacted, that is, the [e.g., @cohen_motor_1986; @sokolov_inner_1972]...

In the discussion of @nalborczyk_understanding_2019, we discussed these findings in length and proposed several theoretical interpretations that can account for these results...

<!--

@nalborczyk_understanding_2019...

@moffatt_inner_2020 stated that:
